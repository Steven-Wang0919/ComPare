# -*- coding: utf-8 -*-
"""
训练 & 评估 KAN（模型内嵌版，无需 KAN_train.py）
...
def train_and_eval_kan(
    ...
    # 组合 train+val 的特征和标签（仍用 train 的 min/max/y_min/y_max）
    ...
    kan_mrs = mean_relative_error(y_test_raw, y_pred_kan)

    print("\n===== KAN 结果 =====")
    print(f"R²  = {kan_r2:.6f}")
    print(f"MRS = {kan_mrs:.6f} %")
